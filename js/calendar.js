$(document).ready(function () {
  ...
  var hh = 0,
    mm = 0,
    ss = 0; //flag(Even if you don't select anything, it helps show the time )
  ...
  $(".btn_hour").click(function () {
    setting();
    showmin_txt_h.style.opacity = "0.5";
    showsec_txt_h.style.opacity = "0.5";
  ...
  $(".btn_min").click(function () {
    setting();
    showhour_txt_m.style.opacity = "0.5";
    showsec_txt_m.style.opacity = "0.5";
  ...
  $(".btn_second").click(function () {
    setting();
    showmin_txt_s.style.opacity = "0.5";
    showhour_txt_s.style.opacity = "0.5";
    $('#myModal_hour').hide();
    $('#myModal_min').hide();
    $('#myModal_second').show();
